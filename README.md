...
4. **Switch Languages** → Select Hindi from dropdown
5. **Toggle Theme** → Click moon/sun icon
6. **Logout** → Login as different role (parent/counselor/admin)
